 ...
 * @brief Teste de Ciclo de Vida do gui-framework
 *
 * Verifica:
 * - Inicialização e shutdown do gui-framework
 * - Criação e destruição de janelas
 * - Ausência de vazamento de memória (usar valgrind)
 *
 * Executar com:
 *   valgrind --leak-check=full ./build/gui-framework/tests/test_lifecycle
 */

#include "test_runner.h"
#include "gui-framework/log.h"
#include "gui-framework/platform/platform.h"
...
int main(void)
{
	...
	BHS_TEST_BEGIN("gui-framework Lifecycle Tests");
