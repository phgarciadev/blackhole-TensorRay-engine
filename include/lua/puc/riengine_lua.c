...
static int bhs_schwarzschild_index(lua_State *L) {
    struct bhs_schwarzschild *obj = luaL_checkudata(L, 1, "bhs_schwarzschild");
    const char *key = luaL_checkstring(L, 2);
    if (strcmp(key, "M") == 0) {
        lua_pushnumber(L, obj->M);
        return 1;
...
static int bhs_blackhole_desc_index(lua_State *L) {
    struct bhs_blackhole_desc *obj = luaL_checkudata(L, 1, "bhs_blackhole_desc");
    const char *key = luaL_checkstring(L, 2);
    if (strcmp(key, "name") == 0) {
        lua_pushstring(L, obj->name);
        return 1;
...
static int bhs_blackhole_data_index(lua_State *L) {
    struct bhs_blackhole_data *obj = luaL_checkudata(L, 1, "bhs_blackhole_data");
    const char *key = luaL_checkstring(L, 2);
...
static int l_bhs_vec4_add(lua_State *L) {
    struct bhs_vec4 arg0 = *(struct bhs_vec4 *)luaL_checkudata(L, 1, "struct bhs_vec4");
    struct bhs_vec4 arg1 = *(struct bhs_vec4 *)luaL_checkudata(L, 2, "struct bhs_vec4");
...
static int l_bhs_vec3_add(lua_State *L) {
    struct bhs_vec3 arg0 = *(struct bhs_vec3 *)luaL_checkudata(L, 1, "struct bhs_vec3");
    struct bhs_vec3 arg1 = *(struct bhs_vec3 *)luaL_checkudata(L, 2, "struct bhs_vec3");
...
static int l_bhs_ecs_create_world(lua_State *L) {
    ...
    bhs_world_handle *ret_obj = lua_newuserdata(L, sizeof(bhs_world_handle));
    *ret_obj = ret;
...
static int l_bhs_metric_zero(lua_State *L) {
    ...
    struct bhs_metric *ret_obj = lua_newuserdata(L, sizeof(struct bhs_metric));
    *ret_obj = ret;
...
static int l_bhs_metric_is_symmetric(lua_State *L) {
    const struct bhs_metric* arg0 = luaL_checkudata(L, 1, "const struct bhs_metric");
    real_t arg1 = (real_t)luaL_checknumber(L, 2);
...
static int l_bhs_metric_dot(lua_State *L) {
    const struct bhs_metric* arg0 = luaL_checkudata(L, 1, "const struct bhs_metric");
    struct bhs_vec4 arg1 = *(struct bhs_vec4 *)luaL_checkudata(L, 2, "struct bhs_vec4");
    struct bhs_vec4 arg2 = *(struct bhs_vec4 *)luaL_checkudata(L, 3, "struct bhs_vec4");
...
static int l_bhs_christoffel_compute(lua_State *L) {
    ...
    real_t arg3 = (real_t)luaL_checknumber(L, 4);
    struct bhs_christoffel* arg4 = luaL_checkudata(L, 5, "struct bhs_christoffel");
...
static int l_bhs_christoffel_zero(lua_State *L) {
    ...
    struct bhs_christoffel *ret_obj = lua_newuserdata(L, sizeof(struct bhs_christoffel));
    *ret_obj = ret;
...
static int l_bhs_geodesic_accel(lua_State *L) {
    const struct bhs_christoffel* arg0 = luaL_checkudata(L, 1, "const struct bhs_christoffel");
    struct bhs_vec4 arg1 = *(struct bhs_vec4 *)luaL_checkudata(L, 2, "struct bhs_vec4");
...
static int l_bhs_kerr_horizon_outer(lua_State *L) {
    const struct bhs_kerr* arg0 = luaL_checkudata(L, 1, "const struct bhs_kerr");
...
static int l_bhs_schwarzschild_metric(lua_State *L) {
    const struct bhs_schwarzschild* arg0 = luaL_checkudata(L, 1, "const struct bhs_schwarzschild");
    double arg1 = (double)luaL_checknumber(L, 2);
    double arg2 = (double)luaL_checknumber(L, 3);
    struct bhs_metric* arg3 = luaL_checkudata(L, 4, "struct bhs_metric");
...
static int l_bhs_scene_add_body_struct(lua_State *L) {
    bhs_scene_t arg0 = luaL_checkudata(L, 1, "bhs_scene_t");
    struct bhs_body arg1 = *(struct bhs_body *)luaL_checkudata(L, 2, "struct bhs_body");
...
static int l_bhs_scene_add_body(lua_State *L) {
    ...
    struct bhs_vec3 arg2 = *(struct bhs_vec3 *)luaL_checkudata(L, 3, "struct bhs_vec3");
    ...
    bhs_entity_id ret = bhs_scene_add_body(arg0, arg1, arg2, arg3, arg4, arg5, arg6);
    bhs_entity_id *ret_obj = lua_newuserdata(L, sizeof(bhs_entity_id));
    *ret_obj = ret;
    luaL_setmetatable(L, "bhs_entity_id");
    return 1;
...
static int l_bhs_scene_add_body_named(lua_State *L) {
    ...
    bhs_entity_id ret = bhs_scene_add_body_named(arg0, arg1, arg2, arg3, arg4, arg5, arg6, arg7);
    bhs_entity_id *ret_obj = lua_newuserdata(L, sizeof(bhs_entity_id));
    *ret_obj = ret;
    luaL_setmetatable(L, "bhs_entity_id");
    return 1;
...
static int l_bhs_body_create_planet_simple(lua_State *L) {
    ...
    double arg2 = (double)luaL_checknumber(L, 3);
    struct bhs_vec3 arg3 = luaL_checkudata(L, 4, "struct bhs_vec3");
    struct bhs_body ret = bhs_body_create_planet_simple(arg0, arg1, arg2, arg3);
    struct bhs_body *ret_obj = lua_newuserdata(L, sizeof(struct bhs_body));
    *ret_obj = ret;
    luaL_setmetatable(L, "bhs_body");
    return 1;
...
static int l_bhs_body_create_star_simple(lua_State *L) {
    ...
    double arg2 = (double)luaL_checknumber(L, 3);
    struct bhs_vec3 arg3 = luaL_checkudata(L, 4, "struct bhs_vec3");
    struct bhs_body ret = bhs_body_create_star_simple(arg0, arg1, arg2, arg3);
    struct bhs_body *ret_obj = lua_newuserdata(L, sizeof(struct bhs_body));
    *ret_obj = ret;
    luaL_setmetatable(L, "bhs_body");
    return 1;
...
static int l_bhs_body_create_blackhole_simple(lua_State *L) {
    ...
    double arg1 = (double)luaL_checknumber(L, 2);
    double arg2 = (double)luaL_checknumber(L, 3);
    struct bhs_body ret = bhs_body_create_blackhole_simple(arg0, arg1, arg2);
    struct bhs_body *ret_obj = lua_newuserdata(L, sizeof(struct bhs_body));
    *ret_obj = ret;
    luaL_setmetatable(L, "bhs_body");
    return 1;
...
static int l_bhs_body_create_from_desc(lua_State *L) {
    const struct bhs_planet_desc* arg0 = luaL_checkudata(L, 1, "const struct bhs_planet_desc");
    struct bhs_vec3 arg1 = *(struct bhs_vec3 *)luaL_checkudata(L, 2, "struct bhs_vec3");
...
static int l_bhs_body_create_from_sun_desc(lua_State *L) {
    const struct bhs_sun_desc* arg0 = luaL_checkudata(L, 1, "const struct bhs_sun_desc");
    struct bhs_vec3 arg1 = *(struct bhs_vec3 *)luaL_checkudata(L, 2, "struct bhs_vec3");
...
static int l_bhs_body_create_from_bh_desc(lua_State *L) {
    const struct bhs_blackhole_desc* arg0 = luaL_checkudata(L, 1, "const struct bhs_blackhole_desc");
    struct bhs_vec3 arg1 = *(struct bhs_vec3 *)luaL_checkudata(L, 2, "struct bhs_vec3");
...
static const struct luaL_Reg riengine_funcs[] = {
    ...
    {"bhs_schwarzschild_metric_inverse", l_bhs_schwarzschild_metric_inverse},
    {"bhs_schwarzschild_redshift", l_bhs_schwarzschild_redshift},
    {"bhs_schwarzschild_escape_velocity", l_bhs_schwarzschild_escape_velocity},
    ...
    {"bhs_body_create_blackhole_simple", l_bhs_body_create_blackhole_simple},
